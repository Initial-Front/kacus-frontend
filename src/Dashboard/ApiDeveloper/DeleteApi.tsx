...
function DeleteClientApi({ setDelete, id }: DeleteClientApiProps) {
    ...
    return (
        <section className='bg-white max-w-[450px] py-[30px] w-full rounded-xl'>
            ...
            <section  className="flex flex-col items-center justify-center">
                ...
                <h1 className="mt-[20px] text-lg">Delete Client API</h1>
                <p>Are you sure you want to delete QuantumTrader API?</p>
