            ...
            <div className="border-b">
              <nav className="flex -mb-px space-x-6">
                <button
                  ...
                  className={`py-3 text-sm ${activeTab === 'overview' ? 'text-blue-600 border-b-2 border-blue-600 font-semibold' : 'text-gray-600'}`}
                >
                  Overview
                </button>
                ...
                <button
                  ...
                  className={`py-3 text-sm ${activeTab === 'specs' ? 'text-blue-600 border-b-2 border-blue-600 font-semibold' : 'text-gray-600'}`}
                >
                  Specifications
                </button>
              </nav>
