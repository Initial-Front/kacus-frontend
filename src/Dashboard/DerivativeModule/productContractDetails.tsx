...
export function Header({ pair }: { pair: PairDetails }) {
    return (
        <div className="shadow-md shadow-[#0A0D120D] border-2 p-[23px] rounded-xl">
                        ...
                        <div className="border-b">
                            <nav className="flex -mb-px space-x-6">
                                <button
                                    ...
                                    className={`py-3 text-sm ${activeTab === 'General' ? 'text-blue-600 border-b-2 border-blue-600 font-semibold' : 'text-gray-600'}`}
                                >
                                    General
                                </button>
                                ...
                                <button
                                    ...
                                    className={`py-3 text-sm ${activeTab === 'LifecycleInformation' ? 'text-blue-600 border-b-2 border-blue-600 font-semibold' : 'text-gray-600'}`}
                                >
                                ...
                                <button
                                    ...
                                    className={`py-3 text-sm ${activeTab === 'RiskControls' ? 'text-blue-600 border-b-2 border-blue-600 font-semibold' : 'text-gray-600'}`}
                                >
                                    Risk Controls
                                </button>
                            </nav>
