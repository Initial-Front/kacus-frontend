...
function TradingMonitoring() {
    ...
    return (
        <main className="p-[32px]">
            ...
            <div className="w-full bg-white rounded-xl border-2 divide-y text-[#111827]  mx-auto mt-12">
                {/* Header */}
                    ...
                    <tbody>
                        {activities.map((item, i) => (
                            <tr key={i} className="border-t">
                                <td className="py-4 px-4">{item.tradeId}</td>
                                <td className="py-4 px-4">{item.name}</td>
                                <td className="py-4 px-4">{item.pair}</td>
