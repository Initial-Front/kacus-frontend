...
import TreasuryEventsTable from "./treauryTable";
            ...
            <main className="mt-[70px]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-[32px]  mx-auto gap-4">
                    {[
                        ...
                        <div
                            key={i}
                            className="p-4 bg-white rounded-xl shadow-sm border-2  flex  flex-col justify-between"
                        >
                            <div className="flex justify-between items-center w-full">
                                <span className=" text-sm md:text-base font-semibold text-[#414651]">{card.title}</span>
                                <button>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
